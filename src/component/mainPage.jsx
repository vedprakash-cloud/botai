...
export default function MainPage({onTemplateClick}){
    ...
    return (
        <div className="flex flex-col justify-center w-full h-96 md:h-full">
            <div className="flex flex-col justify-center items-center mb-5 font-semibold text-lg md:text-4xl">
            <p>How Can I Help You Today</p>
            <div className="w-10 md:w-full flex justify-center">
              <img
              src={profile}
              alt="profile.svg"
            />
          ...
          <div className="flex flex-col items-center md:grid md:grid-cols-2 gap-3 w-full h-80 overflow-hidden">
            {lastFour.map((item) => (
              <div
                key={item.id}
